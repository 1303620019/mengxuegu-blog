 ...
 * @see:com.mengxuegu.generator
 * @author:byl
 * @createTime:2021/11/14 22:19
 * @version:1.0
 */
public class CodeGenerator {

    // 生成的代码放到哪个工程中
    private static String PROJECT_NAME = "mengxuegu-blog-system";

    // 数据库名称
    private static String DATABASE_NAME = "mxg_blog_system";
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://152.136.103.248:3306/"+ DATABASE_NAME +"?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=GMT%2B8");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("Bian2612909");
